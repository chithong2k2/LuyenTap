...
function CourseItems(props) {
    return (
        <div className="course-items">
           <h2 onClick={()=>console.log(props.title)}>{props.title}</h2>
